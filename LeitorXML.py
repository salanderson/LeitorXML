...
def aplicar_tema():
    if modo_dark.get():
        ...
        frame_tema.configure(bg='#2e2e2e')
        frame_modelos.configure(bg='#2e2e2e')
        checkbox_55.configure(bg='#2e2e2e')
        checkbox_65.configure(bg='#2e2e2e')
        checkbox_dark.configure(bg='#2e2e2e')
        checkbox_light.configure(bg='#2e2e2e')
        ...
        frame_tema.configure(bg='SystemButtonFace')
        frame_modelos.configure(bg='SystemButtonFace')
        checkbox_55.configure(bg='SystemButtonFace')
        checkbox_65.configure(bg='SystemButtonFace')
        checkbox_dark.configure(bg='SystemButtonFace')
        checkbox_light.configure(bg='SystemButtonFace')
